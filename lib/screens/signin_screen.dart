    ...
    return Scaffold(
        body: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              SizedBox(height: 100,),
              const Text("Alquila, pedelea y cuida el planeta", style: TextStyle(
                  fontSize: 32,
                  fontWeight: FontWeight.w500,
                  color: Color(0xFF325D67)),),
              const Text("Te brindamos tu bicicleta soñada hoy. \nRegistrate o inicia sesión.", style: TextStyle(
                  fontSize: 15,
              ...
              Column(
                children: [
                  ...
                  Container(
                    ...
                    height: 50,
                    child: TextButton(onPressed: () {}, child: Text("Inciar sesión", style: TextStyle(
                      color: Colors.white,
                      fontSize: 18,
                    ),), style: ButtonStyle(
